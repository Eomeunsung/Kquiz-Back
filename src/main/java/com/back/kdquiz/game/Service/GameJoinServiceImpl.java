...
public class GameJoinServiceImpl implements GameJoinService {
    ...
    public ResponseEntity gameJoinResponse(GameJoinDto gameJoinDto) {
        ...
        String gameId = gameRepositoryRedis.getQuiz(gameJoinDto.getGameId());
//            Long id = Long.parseLong(gameId);
        ...
        Long newId = gameRepositoryRedis.addUser(gameJoinDto.getGameId(), gameJoinDto.getName());
        String quizTitle = gameRepositoryRedis.quizTitleGet(gameJoinDto.getGameId());
